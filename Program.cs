...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("SellYourStuffWebApi_local") ?? throw new InvalidOperationException("Connection string SellYourStuffWebApiContext not found"));
});
